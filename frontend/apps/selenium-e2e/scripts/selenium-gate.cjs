...
const MODE_SCRIPTS = {
  smoke: ['test:smoke:ci'],
  full: ['test:templates:ci', 'test:admin:ci', 'test:reb18:ci', 'test:reb19:ci', 'test:reb20:ci', 'test:reb21:ci', 'test:damtree:ci', 'test:wysiwyg:ci', 'test:reb22:ci', 'test:reb23:ci', 'test:reb24:ci', 'test:reb25:ci', 'test:reb26:ci'],
};
