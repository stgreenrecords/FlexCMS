...
| ID | Status | Title | Effort | Modules Touched | Blocked By |
|----|--------|-------|--------|-----------------|------------|
| TA-00 | 🟢 OPEN | **Foundation & Instrumentation — admin-e2e package, Playwright config, data-testid attributes, fixtures, POMs** | 3d | `apps/admin-e2e` (new), `apps/admin`, `packages/ui` | — |
| TA-01 | 🔴 BLOCKED | **Phase 1 Critical — dashboard, content-tree, page-editor, DAM browser, workflows (UI-001→UI-086)** | 5d | `apps/admin-e2e` | TA-00 |
| TA-02 | 🔴 BLOCKED | **Phase 2 High — sites, PIM catalog, PIM editor, PIM import, PIM schema (UI-052→UI-095)** | 4d | `apps/admin-e2e` | TA-01 |
...
> This section defines the protocol for tracking bugs discovered during Playwright E2E test implementation.
...
### Current Inline Bugs by TA Task
...
- [ ] §6 "Current Inline Bugs" table is up to date
